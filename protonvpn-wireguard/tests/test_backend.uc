...
// The version gate answers Code 5003, "this version of the app is no longer
// supported". The official client format carries a client-type segment:
// 'linux-vpn-<type>@<version>'.
check('PM_APPVERSION is stamped (Code 5003 guard)',
